...
​	虽然已有大量研究聚焦于如何更好地检索出相关片段提升大语言模型或智能助手在下游任务的表现，但对于如何评估AI助手在多轮交互对话的长期记忆能力的工作较少。[**LONGMEMEVAL[18]**](https://arxiv.org/abs/2410.10813)是一个能够全面评估智能助手长期记忆能力的基准，其涵盖了500个人工构建的高质量问题，用于测试五个关于长期记忆方面的核心能力：信息抽取、跨会话推理、时间推理、知识更新与摈弃。而为了全面评估智能助手的长期记忆能力，该论文构建了七种不同类型的题目，分别如下：
...
​	同时，论文提供了一个构造连贯、可拓展且附带时间戳信息的对话方法，**LONGMEMEVAL**基准具体的构建流程如下图所示[源自[18]]()：
